/** Filter helpers for format and day options. */
...
/** Format string normaliser e.g. "IMAX, 4dx , screenx" -> "IMAX,4DX,SCREENX" | null */
...
/** Day string normaliser e.g. "Fri, SAT ,sun" -> "fri,sat,sun" | null */
